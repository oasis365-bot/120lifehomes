...
const FAQS = [
  ...
  { q: "입소까지 얼마나 걸리나요?", a: "공실이 있는 시설은 서류 준비 후 3~7일 내 입소가 가능합니다. 인기 지역·소규모 시설은 대기가 수개월 걸리기도 합니다. 120 라이프홈즈 무료 상담을 이용하면 여러 시설의 실시간 공실을 한 번에 확인할 수 있습니다." },
  { q: "견학은 어떻게 신청하나요?", a: "각 시설 상세 페이지의 '견학·상담 신청' 버튼을 누르거나, 120 라이프홈즈 무료 상담(1600-0000)으로 연락 주시면 상담원이 방문 일정을 조율해 드립니다. 가능하면 식사 시간대에 방문해 실제 급식과 분위기를 확인하시길 권합니다." },
];
